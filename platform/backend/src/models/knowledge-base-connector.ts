  ...
  static async findByKnowledgeBaseId(
    ...
    return await db
      .select({
        ...
        lastPruneStatus: schema.knowledgeBaseConnectorsTable.lastPruneStatus,
        lastPruneError: schema.knowledgeBaseConnectorsTable.lastPruneError,
        cutoffDays: schema.knowledgeBaseConnectorsTable.cutoffDays,
