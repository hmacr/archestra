...
ALTER TABLE "knowledge_base_connectors" ADD COLUMN "last_prune_error" text;--> statement-breakpoint
ALTER TABLE "knowledge_base_connectors" ADD COLUMN "cutoff_days" integer;